---
title: "CGT calls indefinite Groundforce strike at Barcelona-El Prat"
description: "CGT called an indefinite Groundforce walkout at Barcelona-El Prat from August 4. Spain set minimum services. Here is which airlines are covered and what to do."
pubDate: 2026-08-02T14:00:00-04:00
category: Labor
breaking: false
draft: false
image: "/images/articles/barcelona-el-prat-groundforce-strike.jpg"
...
[CGT’s Barcelona section](https://www.cgtbarcelona.org/cgt-convoca-huelga-indefinida-en-groundforce-barcelona-del-aeropuerto-del-prat-barcelona-a-partir-del-4-de-agosto/) registered an indefinite walkout for Groundforce’s El Prat workforce. The [Ministry of Transport minimum-service resolution](https://cdn.transportes.gob.es/portal-web-transportes/aereo/huelga-servicios-minimos/2026/40_26-08-04__--resolucion_ssmm_huelga_groundforce_bcn_vi.pdf) says the company told officials **1,179** workers at the Barcelona base are covered, and that Groundforce-served airlines have about **11,600** movements and roughly **2.4 million** seats programmed from the strike start through September. Based on expected occupancy, the ministry puts about **2 million** passengers in the potential impact window if the dispute runs that long.

The strike has **no fixed end date**. It continues until there is a deal or the union suspends it.
...
| Route type | August | September |
| --- | --- | --- |
| Non-peninsular Spain routes and public-service routes | 80% | 77% |
| International routes, and domestic peninsular routes with a public alternative of about 5 hours or more | 58% | 57% |
| Domestic peninsular routes with a public alternative under about 5 hours | 35% | 36% |

Those percentages are the **minimum** share of scheduled Groundforce-served flights that must keep getting handling support. They do not tell you which individual flights will delay or cancel. How messy any given day gets still depends on how many workers walk out, which flights Groundforce actually covers that day, and how full August already is.

Separately, the resolution protects **100%** of emergency flights and certain Interior Ministry transfer flights when they apply. Positioning operations are covered only when they are needed to support those protected services. Cargo and postal flights are not generally protected at 100%.
...
Other handlers cover other airlines at the same airport. Aena currently lists **American Airlines** under **Menzies**, **Air Canada** under **Aviapartner**, and **British Airways, Iberia, Level, and Vueling** under **South Europe Ground Services**. **Ryanair** and **easyJet** appear under their own handling entries. Those flights are not the direct target of this Groundforce walkout. Confirm with your airline for your exact flight numbers, because handler assignments can change.
...
Groundforce staff at Barcelona-El Prat are called out on an indefinite strike from midnight August 4th. Risk is highest for Groundforce’s airline clients, during peak summer, with ministry minimum services already set. Confirm who handles your flight, leave buffer for bags, and keep watching status until the dispute ends.
